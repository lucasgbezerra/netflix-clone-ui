...
Netflix UI clone, é um clone da interface, que utiliza da base de dados the movie db.
...
É necessário adicionar a apiKey, que pode ser obtida no site [The movie DB](https://www.themoviedb.org/documentation/api)
